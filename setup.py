...
#
	parameters = { "mpPluginsSamsungVersion": get_version() }
	...
	setup(name = "mp_plugins_samsung",
	      version = get_version(),
	      description = "A device centric multimedia solution",
	      long_description = """"mp_plugins_samsung" contains plugins for "Samsung Electronics" devices.""",
	      author = "direct Netware Group et al.",
	      author_email = "web@direct-netware.de",
	      license = "GPLv2+",
	      url = "https://www.direct-netware.de/redirect?mp;plugins_samsung",
